...
<head>
    ...
    <link href="{{ asset('font/css/fontawesome.css') }}" rel="stylesheet" type="text/css">
...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                  {{--   {{ config('app.name', 'Laravel') }} --}}Larapus
                </a>
    ...
    <script type="text/javascript" src="{{ asset('font/js/fontawesome.js') }}"></script>
    @yield('scripts')
</body>
</html>
