...
<div class="form-group{{ $errors->has('author_id') ? 'has-error' : ''}}">
	...
	<div class="col-md-4">
		{!! Form::select('author_id', ['' => '']+App\Author::pluck('name','id')->all(), null,[ 'placeholder'=> 'Pilih Penulis']) !!}
...
<div class="form-group{{ $errors->has('cover') ? 'has-error' : ''}}">
	...
	<div class="col-md-4">
		...
		@if (isset($book) && $book->cover)
			...
			<p>
				<br>
				{!! Html::image(asset('img/'.$book->cover), null, ['class' => 'img-rounded', 'width' => '150px' , 'height'=>'150px'])!!}
			</p>
		@endif
